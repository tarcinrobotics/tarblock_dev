...
Blockly.Blocks['ESPBOY-1']={init:function(){
    this.appendDummyInput()
      .appendField(Blockly.Msg.Start_ESP_Boy)
        .appendField(new Blockly.FieldTextInput("CodeAsthram"), "text");
...
Blockly.Blocks["base_conect_esp8266_kode_12f"] = {
 init: function() {
  ...
  .appendField(new Blockly.FieldTextInput("<h1>CodeAsthram</h1>"), "TEXT");
...
this.appendDummyInput()
.appendField("Name")
.appendField(new Blockly.FieldTextInput("WiFi-CodeAsthram"), "TEXT1");
this.appendDummyInput()
.appendField("Pass")
...
Blockly.Blocks['web_esp_conect']={init:function(){
    this.appendDummyInput()
        ...
        .appendField(new Blockly.FieldTextInput("WiFi-CodeAsthram"), "name")
        .appendField("Pass")
        .appendField(new Blockly.FieldTextInput("12345678"), "pass")
    .appendField("Title")
        .appendField(new Blockly.FieldTextInput("CodeAsthram"), "title");
...
Blockly.Blocks['web_esp_conect_text']={init:function(){
    this.appendDummyInput()
        .appendField("Web - Text")
        .appendField(new Blockly.FieldTextInput("CodeAsthram RU EN"), "name");
    this.setInputsInline(true);
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.setColour(220);
...
Blockly.Blocks['dwin_box_text']={init:function(){
    this.appendDummyInput()
        ...
        .appendField(new Blockly.FieldTextInput("CodeAsthram EN"), "id_text")
        .appendField("x")
        .appendField(new Blockly.FieldTextInput("0"), "x_text")
        .appendField("y")
        .appendField(new Blockly.FieldTextInput("0"), "y_text")
...
Blockly.Blocks['wifi_init_sta'] = {
  ...
  this.appendDummyInput()
    .appendField(Blockly.Msg.WIFI_ssid)
        .appendField(new Blockly.FieldTextInput("WiFi-CodeAsthram"), "SSID")
...
Blockly.Blocks['blynk_begin'] = {
  init: function() {
    ...
    this.setNextStatement(true, null);
    this.setColour(230);
    this.setTooltip("Initialize Blynk with auth token, SSID, and password");
    this.setHelpUrl("");
    this.setInputsInline(true);
  }
};
